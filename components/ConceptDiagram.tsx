    ...
    <div className="w-full flex flex-col items-center pb-12 mt-4 overflow-x-hidden">
      <div className="flex flex-col items-center w-full max-w-5xl px-4 relative overflow-visible">
        ...
        <div className="h-16 flex items-center justify-center my-1 relative -top-2">
          <svg width="40" height="70" viewBox="0 0 40 70" fill="none" className="text-[var(--color-indigo-light)]">
            <path d="M20 0 V60" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-pulse" />
            <path d="M10 50 L20 62 L30 50" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        ...
        <div className="w-full max-w-[800px] h-32 relative -top-3 z-0 hidden md:block">
          <svg width="100%" height="100%" viewBox="0 0 800 120" preserveAspectRatio="none" className="text-[var(--color-indigo-light)]">
            <path d="M400 0 L400 50" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-pulse" />
            <path d="M150 50 L650 50" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-[pulse_1.5s_ease-in-out_infinite]" />
            <path d="M150 50 L150 110 M400 50 L400 110 M650 50 L650 110" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-[pulse_1.5s_ease-in-out_infinite]" />
            <path d="M140 100 L150 112 L160 100 M390 100 L400 112 L410 100 M640 100 L650 112 L660 100" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        ...
        <div className="flex flex-col items-center w-full mt-4 md:mt-0">
          <h2 className="text-sm md:text-base uppercase tracking-[0.2em] font-bold mb-8 text-[rgba(53,34,89,0.5)] text-center px-4">
            2. Distributed across hundreds of partner stores pointing to one place
          </h2>
        ...
        <div className="w-full max-w-[800px] h-32 relative z-0 hidden md:block">
          <svg width="100%" height="100%" viewBox="0 0 800 120" preserveAspectRatio="none" className="text-[var(--color-indigo-light)]">
            <path d="M150 0 L150 60 M400 0 L400 60 M650 0 L650 60" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-pulse" />
            <path d="M150 60 L650 60" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-[pulse_1.5s_ease-in-out_infinite]" />
            <path d="M400 60 L400 110" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-pulse" />
            <path d="M390 100 L400 112 L410 100" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        <div className="h-16 flex flex-col items-center justify-center relative -top-1 md:hidden">
          <svg width="40" height="70" viewBox="0 0 800 120" fill="none" className="text-[var(--color-indigo-light)]">
            <path d="M20 0 V60" stroke="currentColor" strokeWidth="4" strokeDasharray="6 6" className="animate-pulse" />
            <path d="M10 50 L20 62 L30 50" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
