...
export default function OnboardingCreatePage() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      ...
      if (!response.ok) {
        setFormError(translateError(body?.message, "Failed to create Studio."));
        return;
      }
  ...
  return (
    <>
      <Head>
        <title>{t("Create Your Studio | Manifold")}</title>
      </Head>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <label className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder={t("Tell players what your Studio makes.")}
                ...
                <label className="flex items-start gap-3">
                  ...
                  <span className="text-sm font-bold text-white/70">
                    {t("This Studio also publishes other Studios' games")}
                ...
                >
                  {isSubmitting ? t("Creating...") : t("Create Studio")}
                </button>
              </form>
            )}
          </div>
