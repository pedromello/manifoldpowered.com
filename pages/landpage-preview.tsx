...
// Componente para representar cada jogo que entra no sistema
function GameCard({
  color,
  label,
  icon,
...
// Componente para representar as lojas da comunidade
function StoreNode({
  name,
  games,
  description,
  ...
  return (
    <div className="flex flex-col items-center rounded-[2rem] border border-[var(--color-indigo-light)] bg-white/80 p-6 md:p-8 shadow-[0_12px_40px_rgba(214,205,255,0.6)] backdrop-blur transition-all duration-300 hover:shadow-[0_20px_60px_rgba(214,205,255,0.9)] hover:-translate-y-3 w-[85vw] sm:w-[60vw] md:w-full max-w-[340px] shrink-0 snap-center relative overflow-hidden h-full">
      ...
      {/* Catálogo da loja simulando uma vitrine de e-commerce */}
...
export default function LandpagePreview() {
  // Nossos jogos simulados
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--color-purple-dark)] flex flex-col pt-16 pb-32 items-center overflow-x-hidden">
      <Head>
        <title>Concept Preview | Manifold Ecosystem</title>
      </Head>

      <div className="text-center mb-20 max-w-3xl px-6">
        <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight">
          The Evolution of Distribution
        </h1>
        <p className="text-xl leading-relaxed text-[rgba(53,34,89,0.8)]">
          Dozens of games enter through a single point. They are distributed
          organically across thousands of stores. And they all end up securely
          in your universal player library.
        </p>
      </div>

      <div className="flex flex-col items-center w-full max-w-5xl px-4 relative">
        {/* =========================================
            TIER 1: MÚLTIPLOS JOGOS ENTRANDO E O FUNIL
            ========================================= */}
        <div className="flex flex-col items-center">
          ...
          >
            {/* Margem invisível extra no início do scroll */}
            ...
            {/* Margem invisível extra no fim do scroll */}
            <div className="min-w-[4vw] md:hidden"></div>
          </div>
        </div>

        {/* SETAS DESCENDO PRO HUB */}
        ...
        {/* TIER 1.5: PONTO DE ENTRADA ÚNICO (MANIFOLD HUB) */}
        ...
        {/* SETAS DISTRIBUINDO PARA AS LOJAS */}
        ...
        {/* =========================================
            TIER 2: LOJAS DA COMUNIDADE 
            ========================================= */}
        <div className="flex flex-col items-center w-full mt-4 md:mt-0">
          <h2 className="text-sm md:text-base uppercase tracking-[0.2em] font-bold mb-8 text-[rgba(53,34,89,0.5)]">
            2. Distributed across hundreds of partner stores pointing to one
            place
          </h2>
        ...
        {/* SETAS REUNINDO PARA A BIBLIOTECA */}
        <div className="w-full max-w-[800px] h-32 relative z-0 hidden md:block">
          ...
          >
            ...
            <path
              ...
              className="animate-pulse"
            />
            {/* Ramificação horizontal juntando no centro */}
            <path
              d="M150 60 L650 60"
              stroke="currentColor"
              strokeWidth="4"
        ...
        {/* =========================================
            TIER 3: BIBLIOTECA UNIVERSAL DO PLAYER
            ========================================= */}
        <div className="flex flex-col items-center w-full max-w-4xl relative -top-3 md:-top-0">
          <h2 className="text-sm md:text-base uppercase tracking-[0.2em] font-bold mb-6 text-[rgba(53,34,89,0.5)]">
            3. The Final Destination (Player)
          </h2>

          <div className="w-full rounded-[2.5rem] border border-[var(--color-indigo-light)] bg-white/70 p-8 md:p-12 shadow-xl shadow-[var(--color-indigo-lighter)] backdrop-blur-md text-center flex flex-col items-center transition-transform hover:scale-[1.01] duration-500">
            <h3 className="text-3xl md:text-4xl font-black mb-8">
              Your Universal Library
            </h3>

            {/* O estante com todos os jogos que começaram no funil */}
            <div className="flex flex-col justify-center gap-4 md:gap-5 bg-[rgba(214,205,255,0.4)] p-4 md:p-6 rounded-[2.5rem] w-full border border-white/50 shadow-inner">
            ...
            <p className="mt-8 text-[rgba(53,34,89,0.7)] text-lg max-w-2xl leading-relaxed">
              No matter if you supported a small streamer or a massive eSports
              team.{" "}
              <strong className="text-[var(--color-purple-dark)]">
                Every purchase empowers the community and your collection
                remains guaranteed in a single place.
              </strong>
            </p>
          </div>
        </div>
